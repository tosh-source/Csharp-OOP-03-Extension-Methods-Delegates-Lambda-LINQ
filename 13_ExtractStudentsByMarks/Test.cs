...
using _13_ExtractStudentsByMarks.Models;
using SharedClassStudents.Models;

namespace _13_ExtractStudentsByMarks
{
    class Test
    {
        static void Main(string[] args)
        {
            ...
            var takeStudentsWithExcellentMarks = QueryOperations.GetStudentsByMarks(students);
            Console.WriteLine(string.Join("\n", takeStudentsWithExcellentMarks));
        }
    }
}
